...
describe 'Resque::Job before_perform' do
  ...
  it 'it runs before_perform before perform' do
    ...
    assert_equal history, %i[before_perform perform]
  end
...
describe 'Resque::Job after_perform' do
  ...
  it 'it runs after_perform after perform' do
    ...
    assert_equal true, result, 'perform returned true'
    assert_equal history, %i[perform after_perform]
  end
  ...
  it 'raises an error but has already performed if after_perform fails' do
    ...
    assert_equal history, %i[perform after_perform], 'Only after_perform was run'
  end
end
...
describe 'Resque::Job around_perform' do
  ...
  it 'it runs around_perform then yields in order to perform' do
    ...
    assert_equal true, result, 'perform returned true'
    assert_equal history, %i[start_around_perform perform finish_around_perform]
  end
  ...
  it 'raises an error but may handle exceptions if perform fails' do
    ...
    assert_equal history, %i[start_around_perform perform ensure_around_perform], 'Only part of around_perform was run'
  end
  ...
  it 'around_perform is not required to yield' do
    ...
    assert_equal history, %i[start_around_perform finish_around_perform], 'perform was not run'
  end
end
...
describe 'Resque::Job before_enqueue' do
  ...
  class ::BeforeEnqueueJobAbort
    @queue = :jobs
    def self.before_enqueue_abort(_history)
      false
    end
...
describe 'Resque::Job before_dequeue' do
  ...
  class ::BeforeDequeueJobAbort
    @queue = :jobs
    def self.before_dequeue_abort(_history)
      false
    end
